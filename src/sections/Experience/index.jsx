    ...
    <div className="">
        ...
        >
            ...
            <div className={`text-primaryAccent ${isMouseEnter['exp1'] ? "text-primaryTitle":""}`}>
                ...
                <div className="flex gap-4" text-xl>
                    <a href="https://github.com/Jo-Prapansak/vitereact" target="_blank"className="hover:scale-110"><FontAwesomeIcon icon={faGithub}/></a>
                    <a href="https://github.com/Jo-Prapansak/vitereact" target="_blank"className="hover:scale-110"><FontAwesomeIcon icon={faMedium}/></a>
                    <a href="https://github.com/Jo-Prapansak/vitereact" target="_blank"className="hover:scale-110"><FontAwesomeIcon icon={faYoutube}/></a>
                </div>
        ...
        >
            <div>
                ...
                <div>
                    <img src={littlelemon} className="w-5/6 rounded-md border-2 border-primarySubcontent"/>
                </div>
            </div>
            <div className="grid gap-4">
